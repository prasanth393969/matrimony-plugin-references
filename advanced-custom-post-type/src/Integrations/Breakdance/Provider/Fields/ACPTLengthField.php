...
class ACPTLengthField extends ACPTStringField
{
	...
	public function handler($attributes): StringData
	{
		...
		if($render === 'value'){
			...
			return StringData::fromString($before . $length . $after);
		}
		...
		if($uomPosition === 'before'){
			...
			return StringData::fromString($before . $unit . ' ' . $length . $after);
		}
		...
		return StringData::fromString($before . $length . ' ' . $unit . $after);
	}
}
