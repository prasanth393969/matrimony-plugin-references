...
class Skin_Four extends Skin_Base
{
    ...
    public function section_style_top_level_item(Widget_Base $widget)
    {
        ...
        $this->start_controls_tabs(
			'eael_advanced_menu_top_level_item_four_tabs'
		);

		$this->start_controls_tab(
			'eael_advanced_menu_top_level_item_four_tab',
			[
		...
		$this->start_controls_tab(
			'eael_advanced_menu_top_level_item_four_hover_tab',
			[
    ...
    public function section_style_dropdown_item(Widget_Base $widget)
    {
        ...
        $this->start_controls_tabs(
			'eael_advanced_menu_dropdown_item_four_tabs'
		);

		$this->start_controls_tab(
			'eael_advanced_menu_dropdown_item_four_tab',
			[
				'label' => esc_html__( 'Default', 'essential-addons-elementor' ),
			]
		);
		...
		$this->start_controls_tab(
			'eael_advanced_menu_dropdown_item_four_hover_tab',
			[
				'label' => esc_html__( 'Hover', 'essential-addons-elementor' ),
			]
		);
